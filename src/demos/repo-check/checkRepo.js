...
// async function checkRepoDemo(username, repoName, branch, givenLocation, setResultValue, checkingOptions) {
//     /*
//     checkRepoDemo DOES NOT USE the Gitea React Toolkit to fetch the repo
...
//     */
//     // console.log(`I'm here in checkRepoDemo v${CHECK_REPO_VERSION_STRING}
...
//                 addNotice10({priority:996, bookID:ourBookID, message:"Failed to load", filename: thisFilename, location:`${givenLocation} ${thisFilepath}: ${cRgfError}`, repoName});
//                 return;
//             }
//             if (repoFileContent) {

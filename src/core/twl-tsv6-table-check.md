...
import { checkNotesTSV7Table } from './twl-tsv6-table-check';
import { RenderLines, RenderRawResults } from '../demos/RenderProcessedResults';

// Text samples
const textA = `Reference\tID\tTags\tQuote\tOccurrence\tTWLink
2:3\tw3r5\t\t\t\t1\t<br>Boo
...
const textG = `Reference\tID\tTags\tQuote\tOccurrence\tTWLink

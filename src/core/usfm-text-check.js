...
const USFM_VALIDATOR_VERSION = '0.0.7';
...
function checkUSFMText(BBB, filename, givenText, location, optionalCheckingOptions) {
    ...
    function doOurBasicFileChecks(filename, fileText, fileLocation, optionalCheckingOptions) {
        ...
        // Updates the global list of notices
        console.assert(filename !== undefined, "doOurBasicTextChecks: 'filename' parameter should be defined");
        console.assert(typeof filename === 'string', "doOurBasicTextChecks: 'filename' parameter should be a string not a '" + (typeof filename) + "'");
        console.assert(fileText !== undefined, "doOurBasicTextChecks: 'fileText' parameter should be defined");
        console.assert(typeof fileText === 'string', "doOurBasicTextChecks: 'fileText' parameter should be a string not a '" + (typeof fileText) + "'");
        // console.assert( allowedLinks===true || allowedLinks===false, "doOurBasicTextChecks: allowedLinks parameter must be either true or false");
    ...
    function checkUSFMFileContents(filename, fileText, fileLocation) {
        ...
        // Now do the general global checks

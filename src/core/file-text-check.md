...
This `checkFileContents()` function can be passed a text and checks for global errors like mismatching punctuation pairs.
...
const rawResults = checkFileContents('Sample', chosenText, 'in '+chosenTextName+' that was supplied');

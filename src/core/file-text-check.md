...
This `checkFileText()` function can be passed a text and checks for global errors like mismatching punctuation pairs.
...
const rawResults = checkFileText('Sample', chosenText, 'in '+chosenTextName+' that was supplied');

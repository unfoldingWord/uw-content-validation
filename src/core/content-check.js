...
// Entry point for checking words
export function contentCheck(str,format) {
    // return a object with:
    // Total content check and distinct content check
    // List of all the words in textual source order
    // A word frequency map
    // A check of all Markdown Level 1 headings

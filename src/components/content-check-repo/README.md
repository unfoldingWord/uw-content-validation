...
```js
<ContentCheckRepo url='https://git.door43.org/tx-manager-test-data/en_tst' />
```
...
```js
<ContentCheckRepo url='https://git.door43.org/tx-manager-test-data/en_tst/folder2' />
```
...
```js
<ContentCheckRepo url='https://git.door43.org/tx-manager-test-data/en_tst/README.md' />
```
...
```js
<ContentCheckRepo url='https://git.door43.org/tx-manager-test-data/en_tst/folder1/jud.usfm' />
```

```js
<ContentCheckRepo url='https://git.door43.org/tx-manager-test-data/en_tst/folder1/titus.tsv' />
```
...
```js
<ContentCheckRepo url='https://git.door43.org/tx-manager-test-data/CurrentState/notafile' />
```
